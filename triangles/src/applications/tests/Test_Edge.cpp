...
TEST(TestEdge, HaveNoIntersectionUnit)
{
    triangles::Point<2> p11 { std::array<float, 2> { 0.0, 0.0} };
    triangles::Point<2> p12 { std::array<float, 2> { 2.0, 1.0} };
    ...
    EXPECT_FALSE(haveIntersection(edge1, edge2));
}

TEST(TestEdge, HaveOnePointIntersectionUnit)
{
    triangles::Point<2> p11 { std::array<float, 2> { 0.0, 0.0} };
    triangles::Point<2> p12 { std::array<float, 2> { 2.0, 1.0} };
    ...
    triangles::Point<2> p21 { std::array<float, 2> { 2.0, 1.0} };
    triangles::Point<2> p22 { std::array<float, 2> { 4.0, 2.0} };
    
    triangles::Edge<2> edge2 { p21, p22 };

    EXPECT_TRUE(haveIntersection(edge1, edge2));
}

TEST(TestEdge, HaveIntersectionUnit)
{
    triangles::Point<2> p11 { std::array<float, 2> { 0.0, 0.0} };
    triangles::Point<2> p12 { std::array<float, 2> { 2.0, 1.0} };
    ...
    triangles::Point<2> p21 { std::array<float, 2> { 1.0, 0.5} };
    triangles::Point<2> p22 { std::array<float, 2> { 4.0, 2.0} };
